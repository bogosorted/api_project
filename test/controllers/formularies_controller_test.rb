...
class FormulariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formulary" do
    assert_difference('Formulary.count') do
      post formularies_url, params: { formulary: { form_name: @formulary.form_name } }, as: :json
    end
  ...
  test "should update formulary" do
    patch formulary_url(@formulary), params: { formulary: { form_name: @formulary.form_name } }, as: :json
    assert_response 200
  end
